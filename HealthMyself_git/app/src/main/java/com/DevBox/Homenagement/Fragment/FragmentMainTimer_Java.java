...
import com.DevBox.Homenagement.Activity.PopUpActivity;
import com.DevBox.Homenagement.R;
import com.DevBox.Homenagement.Service.WidgetService;
...
public class FragmentMainTimer_Java extends Fragment {
    ...
    ServiceConnection conn = new ServiceConnection() {
        ...
        public void onServiceConnected(ComponentName name,
            ...
            WidgetService.MyBinder mb = (WidgetService.MyBinder) service;
            ws = mb.getService();
            isService = true;
            //연결이 된다면 
        }
